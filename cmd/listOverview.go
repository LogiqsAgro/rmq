...
var listOverviewCmd = &cobra.Command{
	Use:   "overview",
	Short: "Lists some various random bits of information that describe the whole system.",
	Long:  `Lists some various random bits of information that describe the whole system.`,
